/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 99c71bc2419aadeab9ef9b1dad55268f)
// Runtime types generated with workerd@1.20260815.1 2025-12-01 nodejs_compat
interface __BaseEnv_Env {
	CAMPAIGN_STATE: KVNamespace;
	ASSETS: Fetcher;
	...
	DIGITAL_HOME_URL: string;
	NEXT_PUBLIC_DIGITAL_HOME_URL: string;
	API_SECRET_KEY: string;
	API_SIGNATURE_REQUIRED: string;
	API_REQUEST_SIGNATURE_TTL_SECONDS: string;
	ANTHROPIC_API_KEY: string;
	OPENAI_API_KEY: string;
	RESEND_API_KEY: string;
	RESEND_WEBHOOK_SECRET: string;
	CALCOM_WEBHOOK_SECRET: string;
	LOCAL_PREVIEW_ADMIN_EMAIL: string;
	LOCAL_PREVIEW_ADMIN_PASSWORD: string;
	CRM_BACKEND_URL: string;
	WRITE_LIMITER: RateLimit;
	STRICT_LIMITER: RateLimit;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_NAME" | "SITE_URL" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "DIGITAL_HOME_URL" | "NEXT_PUBLIC_DIGITAL_HOME_URL" | "API_SECRET_KEY" | "API_SIGNATURE_REQUIRED" | "API_REQUEST_SIGNATURE_TTL_SECONDS" | "ANTHROPIC_API_KEY" | "OPENAI_API_KEY" | "RESEND_API_KEY" | "RESEND_WEBHOOK_SECRET" | "CALCOM_WEBHOOK_SECRET" | "LOCAL_PREVIEW_ADMIN_EMAIL" | "LOCAL_PREVIEW_ADMIN_PASSWORD" | "CRM_BACKEND_URL">> {}
}
