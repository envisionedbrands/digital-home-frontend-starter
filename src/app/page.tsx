...
/**
 * Homepage — Chronicle architecture (chronicle.northfolk.co), skinned in the
 * site's real brand system per MI 2026-08-14 ("do you see the branding in
 * this page? [/blog] follow it"): Meganté display (@font-face in globals.css,
 * served from owned storage — the file never enters this repo), Inter body,
 * Courier Prime kickers, cool canvas + olive, rose as rare accent. This
 * supersedes the DECISIONS #010 Newsreader/oxblood skin, rejected by MI on
 * sight. Chronicle contributes ARCHITECTURE only: numbered masthead, heavy
 * rules, numbered chapters, ticker bands, act-break photography. All copy is
 * Maria-Ines's, verbatim.
 *
 * Meganté has no italic — <em> renders upright in olive (sage inside .dk
 * dark bands). The global NavBar returns null on "/" — this page carries its
 * own masthead.
 */
...
.ch { --ivory:#FBFAF9; --ink:#1E1E1E; --stone:#EDE9E3; --ox:#4C5A2E; --char:#1E1E1E; --rose:#B87A5D; --sage:#8A9A6B;
...
function Ticker({ items, dark = false }: { items: string[]; dark?: boolean }) {
  ...
  return (
    <div className={`overflow-hidden border-y py-5 ${dark ? 'bg-[color:var(--char)] text-[#FBFAF9] border-transparent' : 'border-[color:var(--ink)] text-[color:var(--ink)]'}`}>
      ...
      <main id="top">
        ...
        <section id="founder-intelligence" className="px-6 pt-24 pb-16">
          <div className="mx-auto max-w-[1360px]">
            <h1 className="nr max-w-[13em] text-[3rem] leading-[1.04] md:text-[4.1rem]">
        ...
        <div className="relative h-[420px] w-full overflow-hidden">
          ...
          <p className="photo-em nr absolute inset-x-6 bottom-10 mx-auto max-w-[1360px] text-[1.5rem] text-[#FBFAF9] md:text-[2rem]">
          ...
          <div className="mx-auto max-w-[1360px]">
            ...
            <div className="mt-12 grid gap-12 lg:grid-cols-[1.15fr_1fr]">
              ...
              <div className="space-y-5 text-[1.08rem] leading-[1.75] lg:pt-2">
                ...
                <p className="nr rose-beat text-[2.2rem] text-[color:var(--rose)]"><em>Use it.</em></p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 pt-12 pb-20">
          <div className="mx-auto max-w-[1360px]">
            ...
            <h2 className="nr mt-4 text-[3rem] leading-[1.02] text-[color:var(--ox)] md:text-[4.4rem]">Founder Intelligence.</h2>
            <div className="mt-12 grid gap-12 lg:grid-cols-[1fr_1fr]">
              <div className="space-y-5 text-[1.08rem] leading-[1.75]">
            ...
            <div className="absolute inset-0 flex items-center px-6">
              <div className="mx-auto w-full max-w-[1360px]">
                ...
                <p className="photo-em mt-4 max-w-[30em] text-[1.05rem] text-[#FBFAF9]/85">
                  One private day. Your real intelligence. A working system. <em className="nr dk-self">The lunch is part of the point.</em>
                </p>
          ...
          <div className="mx-auto max-w-[1360px]">
            ...
            <div className="mt-20 flex flex-col gap-3 border-t border-[#FBFAF9]/20 pt-8 md:flex-row md:items-baseline md:justify-between">
              ...
              <div className="lbl flex flex-wrap gap-x-8 gap-y-2 text-[#FBFAF9]/70">
                <a href="#citc" className="hover:text-[#FBFAF9]">Codified in the City</a>
                <a href="#ways-to-work" className="hover:text-[#FBFAF9]">Ways to Work</a>
